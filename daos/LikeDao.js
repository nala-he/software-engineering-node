...
export default class LikeDao {
    constructor() {
         ...
         */
        this.userLikesTuit = (uid, tid) => __awaiter(this, void 0, void 0, function* () { return LikeModel.create({ likedTuit: tid, likedBy: uid }); });
        /**
         ...
         */
        this.userUnlikesTuit = (uid, tid) => __awaiter(this, void 0, void 0, function* () { return LikeModel.deleteOne({ likedTuit: tid, likedBy: uid }); });
    }
}
