...
export default class BookmarkDao {
    constructor() {
        ...
        this.findTuitsBookmarkedByOther = (me, markedBy) => __awaiter(this, void 0, void 0, function* () {
            return bookmarkModel.find({ markedBy: markedBy !== me ? markedBy : null })
                .populate('markedBy', 'username')
                .populate('markedTuit', 'tuit')
                .exec();
        });
         ...
         */
        this.userUnbookmarksAllTuits = (uid) => __awaiter(this, void 0, void 0, function* () { return bookmarkModel.deleteMany({ markedBy: uid }); });
    }
}
